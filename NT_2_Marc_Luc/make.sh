...
exiftool -overwrite_original -Creator='https://bible.sacy.be/pub/' -Title="[NT 2] Évangile selon St Marc & St Luc" -Author="Le Maistre de Sacy" -Subject="$(tr '\n' ' ' <info.txt)" NT_2_Marc_Luc.pdf